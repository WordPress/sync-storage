...
// Check for Gutenberg with sync storage filter.
// Note: This filter doesn't exist yet - needs Gutenberg PR.
if ( ! has_filter( 'gutenberg_sync_storage' ) ) {
	add_action(
		'admin_notices',
		function () {
			echo '<div class="notice notice-warning"><p>';
			echo esc_html__( 'Realtime Collaboration requires Gutenberg with sync storage filter support. This feature is coming in a future Gutenberg release.', 'realtime-collaboration' );
			echo '</p></div>';
		}
	);
}
